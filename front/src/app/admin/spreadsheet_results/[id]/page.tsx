...
export default function SpreadsheetResultsPage() {
  ...
  return (
    <div className="text-black flex flex-col items-center justify-center p-2 gap-10">
      ...
      <div id="buttons" className="flex justify-between mb-10 w-full">
        <button className="bg-white text-dark-blue border-2 border-dark-blue p-3 rounded-lg mx-2"
          onClick={()=>{router.push("/admin")}}
        >Cancelar</button>
        <button className="bg-dark-blue text-white p-3 rounded-lg mx-2"
          onClick={sendData}
        >Confirmar</button>
      </div>
    </div>
